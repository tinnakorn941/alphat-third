...
const myBot = ['u137a394c553d9c20b741f34a411cc121','u63fb39f39813b9e88d3f20e05f642955','u4cba3a898f70591e980b310313507b34'];
...
\n";
        ...
        if(txt === 'ไป' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'ไป' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
